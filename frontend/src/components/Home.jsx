    ...
    return (<>
        ...
        {user &&
            <div className="flex justify-center items-start ">
                ...
                {screenWidth >= 1024 &&
                    <>
                        <div className={`fixed flex flex-col items-center w-[20vw] z-2 left-8 ${headerVisible ? "transform transition-transform duration-100 ease-in-out translate-y-[90px]" :
                            ...
                            <div   onClick={() => handleMenuTransitions(5)}
                            className="flex justify-start items-center bg-foreground w-full h-[100px] rounded-[10px] overflow-hidden cursor-pointer hover:bg-primary hover:text-foreground shadow-md">
                ...
                <Header headerVisible={headerVisible} screenWidth={screenWidth} user={user} handleMenuTransitions={handleMenuTransitions} menuElements={homeMenuElements({ actPage, handleMenuTransitions })}/>
